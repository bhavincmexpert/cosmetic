                        ...
                        <div class="panel-body">
                            <div class="adv-table">
                                <div id="example_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                    ...
                                    <div class="panel-body" style="float: right"> <a href="<?php echo base_url().'index.php/news/add'; ?>" class="btn btn-primary btn-lg">Add News</a> </div>
                                    ...
                                    <table class="display table table-bordered table-striped dataTable" id="example"
                                        ...
                                        <?php foreach ($result as $app){ ?>
                                            ...
                                            <tr class="gradeX odd">
                                                <td class="">
                                                    <a href="<?php echo base_url().'index.php/news/add/'.$app->id; ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                                                ...
                                                <td class=""><img src="<?php echo base_url().'public/images/news/'.$app->image; ?>" height="50" width="50"></td>
                                            </tr>
...
<script type="text/javascript">
    ...
    function single_delete(value) {
        ...
        $.ajax({
            url: '<?php echo base_url().'index.php/news/single_delete_product/'; ?>' ,
            data: {
                ids: id.toString(),
                url: '<?php echo base_url().'index.php/news/single_delete_product/'; ?>' ,
            },
