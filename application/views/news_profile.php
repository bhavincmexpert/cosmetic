...
<section id="main-content">
    ...
    <form role="form" method="post" action="<?php echo base_url().'index.php/news/add_update/';  ?>" enctype="multipart/form-data" name="service_form">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        <div class="customer">
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" id="description" placeholder="Description"><?php echo $app_result['description']; ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        <div class="customer padding_dropdown margin_btm">
                            <div class="form-group">
                                ...
                                <?php if($app_result['image'] != ''){ ?>
                                    <img src="<?php echo base_url().'public/images/news/'.$app_result['image']; ?>" height="50" width="50">
                                <?php } ?>
    ...
    <footer class="panel-footer text-right bg-light lter">
        ...
        <a href="<?php echo base_url().'index.php/news/index'; ?>" data-toggle='modal' class="btn btn-success btn-s-xs" name="cancel">Cancel</a>
