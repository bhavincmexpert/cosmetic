...
if($admin_id != ''){
    ...
    $app_query = $this->db->query("SELECT * FROM admin WHERE id = '$admin_id'");
...
<section id="main-content">
    ...
    <form role="form" method="post" action="<?php echo base_url().'index.php/admin/update/';  ?>" enctype="multipart/form-data" name="service_form">
                    ...
                    <section class="panel">
                        ...
                        <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                            <div class="customer">
                                ...
                                <div class="form-group">
                                    <label for="">Name</label>
                                    <input type="email" name="email" class="form-control" id="email" placeholder="Email" value="<?php echo $app_result['email']; ?>" required readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                            <div class="customer padding_dropdown margin_btm">
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password" class="form-control" id="password" placeholder="Password" required value="<?php echo $app_result['password']; ?>">
                                </div>
                                <div class="form-group">
    ...
    <footer class="panel-footer text-right bg-light lter">
        ...
        <a href="<?php echo base_url().'index.php/admin/index'; ?>" data-toggle='modal' class="btn btn-success btn-s-xs" name="cancel">Cancel</a>
