...
if($service_id != ''){
    ...
    $app_query = $this->db->query("SELECT * FROM services WHERE id = '$service_id'");
...
<section id="main-content">
    ...
    <form role="form" method="post" action="<?php echo base_url().'index.php/service/add_update/';  ?>" enctype="multipart/form-data" name="service_form">
                        ...
                        <div class="customer padding_dropdown margin_btm">
                            <div class="form-group">
                                ...
                                <?php if($app_result['image'] != ''){ ?>
                                    <img src="<?php echo base_url().'public/images/service/'.$app_result['image']; ?>" height="50" width="50">
                                <?php } ?>
    ...
    <footer class="panel-footer text-right bg-light lter">
        ...
        <a href="<?php echo base_url().'index.php/service/index'; ?>" data-toggle='modal' class="btn btn-success btn-s-xs" name="cancel">Cancel</a>
