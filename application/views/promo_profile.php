...
if($service_id != ''){
    ...
    $app_query = $this->db->query("SELECT * FROM setting WHERE id = '$service_id'");
...
<section id="main-content">
    ...
    <form role="form" method="post" action="<?php echo base_url().'index.php/promo/add_update/';  ?>" enctype="multipart/form-data" name="service_form">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        <div class="customer">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="description" name="description" placeholder="Promo" value="<?php echo $app_result['description']; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        <div class="customer padding_dropdown margin_btm">
                            <div class="form-group">
                                ...
                                <input type="file" name="userfile" class="form-control" id="image" placeholder="Image"> <br>

                                <?php if($app_result['image'] != ''){ ?>
                                    <img src="<?php echo base_url().'public/images/promo/'.$app_result['image']; ?>" height="50" width="50">
                                <?php } ?>
    ...
    <footer class="panel-footer text-right bg-light lter">
        ...
        <a href="<?php echo base_url().'index.php/promo/index'; ?>" data-toggle='modal' class="btn btn-success btn-s-xs" name="cancel">Cancel</a>
