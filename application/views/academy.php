                        ...
                        <div class="panel-body">
                            <div class="adv-table">
                                <div id="example_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                    ...
                                    <div class="panel-body" style="float: right"> <a href="<?php echo base_url().'index.php/academy/add'; ?>" class="btn btn-primary btn-lg">Add Academy</a> </div>
                                    ...
                                    <table class="display table table-bordered table-striped dataTable" id="example"
                                        ...
                                        <?php foreach ($result as $app){ ?>
                                            ...
                                            <tr class="gradeX odd">
                                                <td class="">
                                                    <a href="<?php echo base_url().'index.php/academy/add/'.$app->id; ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
...
<script type="text/javascript">
    ...
    function single_delete(value) {
        ...
        $.ajax({
            url: '<?php echo base_url().'index.php/academy/single_delete_product/'; ?>' ,
            data: {
                ids: id.toString(),
                url: '<?php echo base_url().'index.php/academy/single_delete_product/'; ?>' ,
            },
            success: function (data) {
                ...
                if (data.status == 1) {
                    alert("Academy has been deleted successfully");
                    window.location.reload(true);
                }
                else {
                    alert('Failed to delete selected academy.');
                    window.location.reload(true);
                }
            },
            error: function () {
