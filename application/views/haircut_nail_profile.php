...
<section id="main-content">
    ...
    <form role="form" method="post" action="<?php echo base_url().'index.php/haircut_nail/insert/';  ?>" enctype="multipart/form-data" name="service_form">
                ...
                <section class="panel">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        <div class="customer">
                            ...
                            <div class="form-group">
                                <label for="handle">Images</label>
                                <input id="file-1" type="file" multiple class="file form-control" data-overwrite-initial="false" data-min-file-count="2" name="userfile[]" required>
                            </div>
