...
<section id="main-content">
    ...
    <form role="form" method="post" action="<?php echo base_url().'index.php/academy/add_update/';  ?>" enctype="multipart/form-data" name="service_form">
    ...
    <footer class="panel-footer text-right bg-light lter">
        ...
        <a href="<?php echo base_url().'index.php/academy/index'; ?>" data-toggle='modal' class="btn btn-success btn-s-xs" name="cancel">Cancel</a>
